...
@Database(entities = arrayOf(Anketa::class, Account::class, AnketaTaken::class, Grupa::class, Istrazivanje::class, Odgovor::class, Pitanje::class, PitanjeAnketa::class), version=7)
